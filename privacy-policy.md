...
This policy explains how the Bot handles your data.

1. **Data Collection:** The Bot may store minimal data such as user IDs or message content only for core features.
2. **Data Use:** Data is used only for providing the Bot’s functionality. We do not sell or share your data.
